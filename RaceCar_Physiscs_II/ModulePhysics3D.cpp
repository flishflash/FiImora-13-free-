...
PhysVehicle3D* ModulePhysics3D::AddVehicle(const VehicleInfo& info)
{
	...
	btCollisionShape* colShape = new btBoxShape(btVector3(info.chassis_size.x*1.5f, info.chassis_size.y*1.5f, info.chassis_size.z*0.5f));
	shapes.add(colShape);

	btTransform trans;
	trans.setIdentity();
	trans.setOrigin(btVector3(info.chassis_offset.x * 1.5f, info.chassis_offset.y*1.5f, info.chassis_offset.z));
